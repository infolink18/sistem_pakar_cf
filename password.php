...
if (isset($_POST['save'])) {
    ...
    if (empty($error)) {
        if (mysqli_num_rows(mysqli_query($con, "select * from user where id_user='" . $id_user . "' and password='" . $password . "'")) > 0) {
            mysqli_query($con, "update user set password='" . $password_baru . "' where id_user='" . $id_user . "'");
